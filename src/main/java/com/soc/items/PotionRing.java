...
public class PotionRing extends RingItem {
    ...
    public static void initialise() {
        addItemToGroups(LESSER_SPEED_RING, ItemGroups.COMBAT);
        addItemToGroups(GREATER_SPEED_RING, ItemGroups.COMBAT);
        addItemToGroups(LESSER_JUMP_RING, ItemGroups.COMBAT);
        addItemToGroups(GREATER_JUMP_RING, ItemGroups.COMBAT);
    }
